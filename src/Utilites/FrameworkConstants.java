...
public class FrameworkConstants {
	 ...
	 * 
	 * if (extentReportFilePath.isEmpty()) { extentReportFilePath =
	 * createReportPath(); } return extentReportFilePath; }
	 */

	/*
	 * private static String createReportPath() { // if //
	 * (PropertyUtils.get(ConfigProperties.OVERRIDE_REPORTS).equalsIgnoreCase("no"))
	 * // { if
	 * (ConfigLoader.getInstance().getOverrideReports().equalsIgnoreCase(getNo())) {
	 * 
	 * 
	 * Report name -> Windows_10_Tue_Oct_05_02_30_46_IST_2021_AutomationReport.html
	 * 
	 * return EXTENT_REPORT_FOLDER_PATH + OSInfoUtils.getOSInfo() + "_" +
	 * getCurrentDate() + "_" + getExtentReportName();
	 * 
	 * } else { return EXTENT_REPORT_FOLDER_PATH + getExtentReportName(); } }
	 */
